...
/* ===================== FINAL REVIEW — EXTRA (HARDER) QUESTIONS ===================== */
(function(){
 const add=(top,qs)=>{
   const l=window.COURSE.find(x=>x.id==="LR"); if(!l) return;
   const t=l.topics.find(x=>x.id===top); if(!t) return;
   qs.forEach(q=>t.quiz.push(q));
 };
 ...
 /* ---------- LRT1 — L3 highlights ---------- */
 add("LRT1",[
  {type:"mcq",q:"Two beetle species are each grown alone and both thrive. When cultured together, species B steadily disappears while A persists. This best demonstrates:",opts:["Trait displacement","Competitive exclusion","Mutualism","Secondary succession"],a:1,exp:"On the same niche, one competitor is driven out — competitive exclusion (as in Gause's experiment)."},
  {type:"mcq",q:"Where two lizard species overlap, one evolves a larger jaw and the other a smaller jaw, though both have intermediate jaws where they live alone. This is:",opts:["Competitive exclusion","Trait (character) displacement","Aposematism","Amensalism"],a:1,exp:"Traits diverge specifically where the competitors co-occur, reducing overlap — trait displacement."},
  {type:"mcq",q:"Removing a single prey species collapses a simple food chain but barely affects a complex food web. The best reason is that food webs have:",opts:["Fewer species","Redundant feeding pathways that buffer the loss","Only one trophic level","No decomposers"],a:1,exp:"Interconnected, redundant pathways make webs more stable than a single linear chain."},
  {type:"mcq",q:"A reef battered by storms very frequently, and one never disturbed, both have LOW coral diversity, while a moderately disturbed reef has the highest. This illustrates:",opts:["The species–area relationship","The intermediate disturbance hypothesis","Biomagnification","Competitive exclusion only"],a:1,exp:"Diversity peaks at intermediate disturbance — the IDH."},
  {type:"mcq",q:"Which correctly pairs a successional stage with its species type?",opts:["Early succession → K-selected, large trees","Late succession → r-selected pioneers","Early succession → r-selected pioneers; late → K-selected","Both stages are r-selected"],a:2,exp:"Early = r-selected (small, fast, good dispersers); late = K-selected (large, slow, strong competitors)."},
  {type:"mcq",q:"A lava flow cools into bare rock with no soil, and lichens are the first to colonize. This is:",opts:["Secondary succession","Primary succession","The climax community","A disturbance only"],a:1,exp:"No soil and no prior community → primary succession; pioneers like lichens build soil."},
  {type:"tf",q:"At very HIGH disturbance, diversity is low because only disturbance-tolerant pioneer species survive.",a:true,exp:"True — frequent/severe disturbance leaves only hardy pioneers; low disturbance instead allows competitive exclusion."},
  {type:"short",q:"A student says 'the finches on different islands starving each other out is trait displacement.' Correct or refine this statement.",model:"That describes competitive exclusion, not trait displacement. Competitive exclusion is when two species competing for the same resource cannot coexist and one is eliminated. Trait displacement is different: it is the evolutionary divergence of a trait, such as beak depth, where two species co-occur, which reduces competition and actually allows them to coexist rather than one excluding the other.",pts:["Starving out = competitive exclusion","Trait displacement = traits diverge where species overlap","Trait displacement enables coexistence (not elimination)"]}
 ]);

 /* ---------- LRT2 — L4 highlights ---------- */
 add("LRT2",[
  {type:"mcq",q:"An SDM maps a valley as highly suitable, yet the species is absent there because a competitor already occupies it. Which BAM component is unmet?",opts:["Abiotic","Biotic","Movement","None — the model is wrong"],a:1,exp:"Climate (abiotic) is fine; the biotic condition fails because a competitor excludes it."},
  {type:"mcq",q:"An SDM predicts suitable habitat on a remote island, but the plant never colonized it because its seeds can't cross the ocean. This reflects a failure of which BAM component?",opts:["Abiotic","Biotic","Movement (dispersal)","Richness"],a:2,exp:"Dispersal (movement) failed — the species couldn't reach the suitable habitat."},
  {type:"mcq",q:"A survey doubles its area but records exactly the same number of species. Which assumption of the species–area relationship is most likely violated?",opts:["That area matters","That all species were detected/identified (some were missed)","That climate is constant","That the species are endemic"],a:1,exp:"If more area yields no new species, detection is likely incomplete — the assumption that all species are found/identified fails."},
  {type:"mcq",q:"A beetle native only to a single mountain is later accidentally introduced to a second mountain by humans. Is it still 'endemic' to the first mountain?",opts:["Yes — endemism refers to natural distribution","No — it now lives in two places","Only if the beetle is rare","Endemism doesn't apply to insects"],a:0,exp:"Endemism is about NATURAL occurrence in one area; a human introduction elsewhere doesn't change its endemic status to its native range."},
  {type:"mcq",q:"Which correctly lists an SDM's inputs AND its key limitation?",opts:["Inputs: predators & prey; limitation: too much data","Inputs: occurrence records & environmental data; limitation: suitable ≠ occupied","Inputs: DNA; limitation: needs no data","Inputs: fossils; limitation: predicts occupancy exactly"],a:1,exp:"Inputs = occurrence records + environmental data; the limitation is that predicted-suitable habitat may not be occupied."},
  {type:"tf",q:"Because an SDM mostly captures the abiotic conditions, it can overpredict a species' actual range.",a:true,exp:"True — it maps suitable (abiotic) habitat; biotic exclusion and dispersal limits mean the real range is often smaller."},
  {type:"short",q:"Explain why 'suitable habitat' from an SDM does not guarantee a species is present, using the BAM framework.",model:"An SDM mainly identifies where abiotic conditions (the A of BAM) are suitable, but actual occupancy also requires suitable biotic conditions (B) — enough resources and tolerable competitors and predators — and the ability to disperse there (M, movement). So a site can be climatically perfect yet unoccupied because a competitor excludes the species or because it could never reach the area. The real range is only where all three overlap.",pts:["SDM captures mainly abiotic suitability (A)","Biotic exclusion (B) can keep it out","Dispersal barriers (M) can keep it out","Range = overlap of B, A, M"]}
 ]);

 /* ---------- LRT3 — L5 highlights ---------- */
 add("LRT3",[
  {type:"mcq",q:"A giraffe stretches its neck reaching high leaves and (supposedly) passes a longer neck to its offspring. Whose (incorrect) idea is this?",opts:["Darwin's natural selection","Lamarck's inheritance of acquired characteristics","Genetic drift","Hardy–Weinberg"],a:1,exp:"Inheritance of acquired characteristics is Lamarck's mechanism — incorrect, because acquired traits aren't heritable."},
  {type:"mcq",q:"An organism lives the longest of all in its population but produces no surviving offspring. Its fitness is:",opts:["Very high (it survived)","Low — fitness requires reproductive success","Average","Undefined"],a:1,exp:"Fitness is measured by reproductive success; long life with no offspring means low fitness."},
  {type:"mcq",q:"Which change in allele frequency is due to a RANDOM process?",opts:["A flood by chance wipes out most of the red-flowered plants in a small population","A predator preferentially eats the slowest gazelles","Females choose the most colorful males","Immigrants bring in a new allele"],a:0,exp:"A chance event randomly changing frequencies in a small population is genetic drift (random). The others are selection, non-random mating, and gene flow (non-random)."},
  {type:"mcq",q:"A population's observed genotype frequencies differ significantly from Hardy–Weinberg expectations. The best conclusion is:",opts:["The population is at equilibrium","The population is evolving (some force is acting)","The sample is too large","Mutation has stopped"],a:1,exp:"Deviation from the HW null model indicates an evolutionary force is acting — the population is evolving."},
  {type:"mcq",q:"Which statement about natural selection is TRUE?",opts:["It creates new alleles","It is a random process","It favors alleles that improve fitness and is non-random","It only acts on asexual species"],a:2,exp:"Selection is non-random and favors fitness-improving alleles; it acts on existing variation (mutation creates new alleles)."},
  {type:"mcq",q:"Which is the ONLY mechanism that introduces brand-new alleles into the gene pool?",opts:["Genetic drift","Gene flow","Mutation","Natural selection"],a:2,exp:"Only mutation creates new alleles; gene flow moves existing alleles between populations."},
  {type:"tf",q:"Genetic drift and natural selection are both random with respect to fitness.",a:false,exp:"False — genetic drift is random, but natural selection is non-random (it favors fitness-improving alleles)."},
  {type:"short",q:"Why is Lamarck still considered important even though his mechanism was wrong? And how does his idea differ from Darwin's?",model:"Lamarck is important because he was among the first to seriously propose that species change over time to adapt to their environments, which was a foundational and influential idea. His mechanism — use and disuse plus the inheritance of acquired characteristics — is wrong because traits acquired during an individual's lifetime are not heritable. Darwin's natural selection differs because it acts on pre-existing heritable variation: individuals that already carry advantageous heritable traits survive and reproduce more, so those traits become more common, rather than traits being acquired and then passed on.",pts:["First to propose species change over time (foundational)","Lamarck: acquired traits inherited (incorrect — not heritable)","Darwin: acts on pre-existing heritable variation","Advantageous heritable traits spread via differential reproduction"]}
 ]);

 /* ---------- LRT4 — L6 trees & clades ---------- */
 add("LRT4",[
  {type:"mcq",q:"A group is drawn that contains a common ancestor and every single one of its descendants. This group is:",opts:["Paraphyletic","Monophyletic (a clade)","Polyphyletic","Not a valid group"],a:1,exp:"Ancestor + ALL descendants = monophyletic = a clade."},
  {type:"mcq",q:"'Warm-blooded animals' grouped as birds + mammals (which evolved warm-bloodedness separately, excluding their cold-blooded common ancestor) is:",opts:["Monophyletic","Paraphyletic","Polyphyletic","A clade"],a:2,exp:"Members come from two lineages and exclude their common ancestor — polyphyletic (endothermy is convergent)."},
  {type:"mcq",q:"On a tree, taxa A and B share a node that is MORE recent than the node A shares with C. Therefore:",opts:["A is more closely related to C","A is more closely related to B","All three are equally related","C is the ancestor of A"],a:1,exp:"Closer relationship = more recent common ancestor; A shares a more recent node with B."},
  {type:"mcq",q:"You rotate two branches around a node so the tips appear in a different left-to-right order. The relationships shown are:",opts:["Now different","Unchanged — only branching pattern matters","Reversed","Invalid"],a:1,exp:"Rotating at a node doesn't change relationships; tip order is arbitrary."},
  {type:"mcq",q:"'Fish' (excluding the tetrapods that evolved from within them) is an example of a ____ group, and it exists because classification used ____.",opts:["polyphyletic; DNA","paraphyletic; observable traits rather than evolutionary history","monophyletic; ancestry","polyphyletic; geography"],a:1,exp:"Like reptiles, 'fish' excludes some descendants (tetrapods) → paraphyletic, a result of trait-based classification."},
  {type:"tf",q:"A monophyletic group can never leave out any descendant of its common ancestor.",a:true,exp:"True — by definition a clade includes the ancestor and ALL descendants; leaving one out makes it paraphyletic."},
  {type:"short",q:"A circled clade on a tree contains an ancestor and all but one of its descendants (that one descendant is left outside the circle). Classify the circled group and justify it.",model:"The circled group is paraphyletic. A monophyletic group must contain a common ancestor and all of its descendants, but here one descendant of the ancestor is excluded from the group. Including an ancestor and only some — but not all — of its descendants is the definition of a paraphyletic group, the same situation as traditional 'reptiles' excluding birds.",pts:["Paraphyletic","Contains ancestor + some but not all descendants","One descendant is excluded","Same as reptiles excluding birds"]}
 ]);

 /* ---------- LRT5 — L6 parsimony, morphies, homoplasy, models ---------- */
 add("LRT5",[
  {type:"mcq",q:"Tree 1 requires 6 character-state changes; Tree 2 requires 4; Tree 3 requires 5. Which does maximum parsimony favor?",opts:["Tree 1","Tree 2","Tree 3","They are equally good"],a:1,exp:"Fewest steps wins — Tree 2 (4 changes) is most parsimonious."},
  {type:"mcq",q:"A derived feature is found in only ONE species on the tree. It is a ____ and is NOT useful for grouping taxa.",opts:["synapomorphy","autapomorphy","plesiomorphy","homology"],a:1,exp:"An autapomorphy is a derived state unique to one species, so it can't unite two or more taxa into a clade."},
  {type:"mcq",q:"The wings of insects and the wings of birds both provide flight but evolved independently. These wings are:",opts:["Homologous","Homoplasious (convergent)","A synapomorphy uniting insects and birds","Plesiomorphic"],a:1,exp:"Independently evolved similar structures = homoplasy from convergent evolution."},
  {type:"mcq",q:"Cacti (Americas) and euphorbs (Africa) both evolved thick, spiny, water-storing stems independently. This similarity is:",opts:["Homology from a recent ancestor","Homoplasy from convergent evolution under similar (desert) selective pressures","A shared derived trait uniting them","Random"],a:1,exp:"Similar traits evolved independently under similar pressures — convergent evolution → homoplasy."},
  {type:"mcq",q:"A shared derived character state used to unite two taxa into a clade is a:",opts:["plesiomorphy","autapomorphy","synapomorphy","homoplasy"],a:2,exp:"Synapomorphy = shared derived state; it is the grouping evidence in parsimony."},
  {type:"mcq",q:"In parsimony, a state shared with the outgroup is treated as ancestral. This step is called:",opts:["rooting","polarization","alignment","calibration"],a:1,exp:"Polarization determines which states are ancestral (0, shared with outgroup) vs derived (1)."},
  {type:"mcq",q:"A lineage shows long stasis, then a daughter species branches off rapidly and then stays stable. Which model is this?",opts:["Phyletic gradualism","Punctuated equilibria","Punctuated gradualism","Anagenesis"],a:1,exp:"Stasis + rapid change WITH branching (cladogenesis) = punctuated equilibria."},
  {type:"mcq",q:"A lineage changes rapidly in a burst but does NOT split into new species. Which model?",opts:["Phyletic gradualism","Punctuated equilibria","Punctuated gradualism","Convergent evolution"],a:2,exp:"Rapid change WITHOUT cladogenesis = punctuated gradualism."},
  {type:"tf",q:"A synapomorphy is a type of derived state, whereas a plesiomorphy is ancestral.",a:true,exp:"True — synapomorphy (shared) and autapomorphy (unique) are derived; plesiomorphy is ancestral."},
  {type:"short",q:"The bones inside a bird wing and a bat wing are homologous, yet 'wings for flight' in birds and bats are homoplasious. Explain how both statements can be true.",model:"The two claims describe different features. The arm bones (humerus, radius, ulna, etc.) inside both wings are homologous because birds and bats inherited them from a shared tetrapod ancestor with those bones. However, the ability to fly using a wing evolved independently in the two lineages — birds fly with feathered wings and bats with skin membranes — so flight itself is homoplasious, a product of convergent evolution rather than shared ancestry. Thus the underlying structure is homologous while the flight adaptation is homoplasious.",pts:["Arm bones inherited from a common ancestor = homology","Flight evolved independently (feathers vs membranes) = homoplasy","Convergent evolution produced flight separately","Structure homologous, flight-adaptation homoplasious"]}
 ]);

 /* ---------- LRT6 — L7 highlights ---------- */
 add("LRT6",[
  {type:"mcq",q:"A platypus and a beaver look superficially similar but are distantly related. Using morphology alone to group them would be an error caused by:",opts:["Subjective coding","Convergent evolution misleading the analysis","Too few traits","Slow evolution"],a:1,exp:"Convergence produces misleading similarity — a key limitation of morphology-based trees."},
  {type:"mcq",q:"Two researchers score the same specimens' color differently ('orange' vs 'brown'), producing different trees. This limitation is:",opts:["Convergent evolution","Subjectivity in trait coding","Dispersal limitation","Biomagnification"],a:1,exp:"Subjective trait coding is a limitation of morphological phylogenies."},
  {type:"mcq",q:"You want to resolve relationships among species that diverged only recently. The better marker is:",opts:["Slow-evolving coding DNA","Fast-evolving non-coding DNA","Morphology only","A single conserved protein"],a:1,exp:"Non-coding DNA evolves faster, providing the variation needed to resolve recent (shallow) splits."},
  {type:"mcq",q:"You want to resolve very ancient relationships among deeply divergent lineages. The better marker is:",opts:["Fast-evolving non-coding DNA","Slow-evolving, conserved coding DNA","Any random sequence","Flower color"],a:1,exp:"Conserved coding DNA's slow, clear signal suits deep/ancient relationships."},
  {type:"mcq",q:"Why is coding DNA conserved (slow-evolving)?",opts:["It is never copied","Harmful changes to it are removed by natural selection","It has no function","It mutates less by chance"],a:1,exp:"Because it makes proteins, deleterious mutations are selected against, keeping it conserved."},
  {type:"tf",q:"Non-coding DNA generally evolves faster than coding DNA because it has fewer functional constraints.",a:true,exp:"True — fewer constraints mean mutations accumulate faster, useful for recent divergences."},
  {type:"short",q:"A study of two recently separated populations used a slow-evolving coding gene and found the sequences identical, giving no resolution. What went wrong, and what should they use instead?",model:"The problem is a mismatch between the marker and the timescale. Coding DNA is conserved and evolves slowly, so over a short time since divergence too few mutations have accumulated to distinguish recently separated populations, leaving the sequences identical. To resolve recent, shallow relationships they should use fast-evolving non-coding DNA, which has fewer functional constraints and accumulates more variation, providing better resolution among closely related taxa.",pts:["Coding DNA is too conserved/slow for recent splits","Not enough mutations accumulated yet","Use fast-evolving non-coding DNA","Non-coding gives resolution among close relatives"]}
 ]);
})();
