...
<text x="322" y="212" fill="currentColor" font-size="16">ICA, renal, liver, placenta</text>
  ...
  questions: [
    ...
    { id: "u11-q38", type: "tf", q: "Turbulent flow is silent and cannot be heard with a stethoscope.", answer: false, explain: "False. Turbulence produces an audible bruit and often a palpable thrill; it is laminar flow that is silent.", objectives: ["u11-o6", "u11-o5"], lesson: "u11-l5", level: 1 }
  ],
